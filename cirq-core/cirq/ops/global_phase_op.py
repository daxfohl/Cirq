...
from cirq.ops import raw_types, controlled_gate as cg, control_values as cv, diagonal_gate as dg
...
class GlobalPhaseGate(raw_types.Gate):
    ...
    def controlled(
        ...
        if self._is_parameterized_() or not isinstance(result, cg.ControlledGate):
            return result
